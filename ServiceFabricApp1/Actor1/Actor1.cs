...
namespace Actor1
{
    ...
    internal class Actor1 : Actor, IActor1
    {
        ...
        {
            var config = instance.Context.CodePackageActivationContext.GetConfigurationPackageObject("Config");
            ...
            var optouts = await repo.GetOptOutsAsync();
